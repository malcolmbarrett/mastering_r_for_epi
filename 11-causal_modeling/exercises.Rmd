...
We're going to fit the marginal structural model using `geeglm()` from the geepack package. We need to use this because it gives us more accurate confidence intervals.
